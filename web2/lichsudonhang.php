...
$sql = "SELECT IDDH,TONG,TRANGTHAI,TIME, DATE_FORMAT(TIME, '%Y-%m-%d') AS formatted_date FROM dh where IDKH = '$idkh'";
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) { $iddh=$row['IDDH'] ?>
                                        <tr>
                                            ...
                                            <td><a href="chitietdonhang.php?IDDH=<?php echo $iddh;?>" class="btn-detail">Xem</a></td>
                                        </tr>
                                    <?php }
                                }
                                else 
